...
--
-- There is still no migration framework here (tracked as Phase 2 of the
-- production-readiness remediation plan — node-pg-migrate). Until then,
-- any schema change to an already-running database needs a hand-written,
-- reviewed ALTER statement, not a re-run of this file.
-- =====================================================================
