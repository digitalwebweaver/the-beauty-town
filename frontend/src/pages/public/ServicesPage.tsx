...
function ServicesPage() {
  ...
  const [genderTab, setGenderTab] = useState<string>('all');
  ...
  const services = useServices({
    categoryKey: tab === 'all' ? undefined : tab,
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 md:px-8">
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-4xl font-bold md:text-5xl">Every service you love</h1>
        <p className="mt-3 max-w-2xl text-muted-foreground">
          From everyday grooming to bridal makeovers — explore our complete menu.
        </p>
      </div>
